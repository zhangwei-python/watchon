...
SECRET_KEY = 'g-zx%563cngooa18b30q!=*@!21*(n5_9qt*4z^yo8y_54pe4c'
...
INSTALLED_APPS = [
    ...
    'cookits_app.apps.CookitsAppConfig',
...
MIDDLEWARE = [
    ...
    # 'users.middleware.simple_middleware2',

    "users.middleware.MiddleWare",
    "users.middleware.MiddleWare2",
...
CACHES = {
    "default": {
        ...
        # redis服务器地址: 127.0.0.1:6379/1 : 1表示1号数据库
